...
class LocalData
    ...
    constructor() {
        ...
        private fun globalParameters(parameters: Parameters): Parameters =
            parameters.copy(
        ...
        fun update(
            ...
            return if (
                ...
                if (dataArea != null) {
                    ...
                    Log.d(
                        LOG_TAG,
                        "LocalData.update() disabled from center ${round(boundingBox.centerLongitude * 100) / 100}, ${ round(boundingBox.centerLatitude * 100) / 100 } ",
                    )
                }
...
fun calculateLocalCoordinate(
    coordinate: Double,
    scale: Int = LOCAL_DATA_SCALE,
): Int {
